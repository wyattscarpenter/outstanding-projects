...
- https://github.com/wyattscarpenter/unsong-book-fetcher/issues/10 unsong book angle brackets. Requires the prerequisite of me rebasing the entire project, but that can be done after a PR is submitted. Also, you may find the project doesn't work out of the box, due to another issue I never addressed. But that's fine, that can just be PR'd as well (before the angle bracket change). Come to think of it there are more little unsong fixes I should dispatch someone to do. Very simple on their own.
